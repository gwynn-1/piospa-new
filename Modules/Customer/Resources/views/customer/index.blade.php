                        ...
                        <div class="m-form m-form--label-align-right m--margin-bottom-30">
                            <div class="row align-items-center m--margin-bottom-10">
                                ...
                                <div class="col-xl-6 order-1 order-xl-2 m--align-right">
                                    ...
                                    <a href="{{ route('customer.add') }}" class="btn m-btn--pill m-btn--air btn-primary"><i class="la la-plus-square"></i> Thêm khách hàng</a>
...
@section('after_script')
    <script src="{{asset('static/backend/js/admin/customer/list.js')}}" type="text/javascript"></script>
@stop
...
class ServicesTable extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['service_id', 'service_name', 'service_code', 'service_time_id', 'description', 'services_image', 'detail', 'is_active', 'is_delete', 'created_at', 'updated_at', 'created_by', 'updated_by'];

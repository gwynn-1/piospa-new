                                ...
                                <div class="modal-body">
                                    ...
                                    {{--<form  id="formExport" method="GET"--}}{{--   //lam export kieu ajax ma ko duoc--}}
                                        ...
                                        {{--<div class="form-group m-form__group row">--}}
                                            ...
                                            {{--<div class="col-lg-3">--}}
                                                {{--<label><input type="checkbox" id="detail" name="checkboxes[]" value="created_at">Ngày tạo</label>--}}
                                            {{--</div>--}}
                                            {{--<div class="col-lg-3">--}}
                                    ...
                                    <form  action="{{route('order-delivery-status.export-excel')}}" id="formExport" method="GET" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-lg-3">
                                                <label><input type="checkbox" id="detail" name="checkboxes4" value="created_at,NGAY TAO">Ngày tạo</label>
                                            </div>
                                            <div class="col-lg-3">
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/admin/order-delivery-status/list.js')}}" type="text/javascript"></script>

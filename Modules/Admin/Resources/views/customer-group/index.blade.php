                        ...
                        <div class="m-form m-form--label-align-right m--margin-bottom-30">
                            <div class="row align-items-center m--margin-bottom-10">
                                        ...
                                        <div class="input-group col-xs-10">
                                            <div class="input-group-append">
                                                <select class="form-control search-type" name="search_type">
                                                    <option value="customer_group_name">Tên</option>
                                                    <option value="customer_group_code">Mã nhóm</option>
                                                </select>
                                            </div>
                                            ...
                                            <div  class="input-group-append" style="margin-left: 10px;">
                                                <a href="{{route('customer-group')}}" class="btn btn-primary">
                                ...
                                <div class="col-xl-6 order-1 order-xl-2 m--align-right">
                                    <a href="{{route('customer-group.add')}}" class="btn m-btn--pill m-btn--air btn-primary"><i class="la la-plus-square"></i> Thêm nhóm khách hàng</a>

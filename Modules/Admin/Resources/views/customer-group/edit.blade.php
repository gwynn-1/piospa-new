    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="m-portlet m-portlet--mobile ">
                ...
                {{-- START FORM --}}
                {{ Form::model($OBJECT, array('method' => 'post','enctype'=>"multipart/form-data",'route' => array('customer-group.edit',$OBJECT->customer_group_id) ,'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed')) }}
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-3 {{ $errors->has('customer_group_image') ? ' has-danger' : '' }}">
                            ...
                            <span class="input-group-btn">
                                ...
                                @if(!empty($OBJECT->customer_group_image))
                                    <a  href="{{asset($OBJECT->customer_group_image)}}" target="_blank" ><img id="image_update" class="img-responsive img-thumbnail" src="{{asset($OBJECT->customer_group_image)}}" alt="" style="max-width: 300px; max-height: 155px;"></a>
                                @endif
                                @if ($errors->has('customer_group_name'))
                                    <span class="form-control-feedback">
                ...
                <input type="hidden" name="customer_group_id" value="{!!  $OBJECT->customer_group_id !!}"/>

            ...
            <div class="modal-body">
                ...
                <form action="{{route('admin.order-status.export')}}" id="form1" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group m-form__group row">
                        <div class="col-lg-4">
                            <input type="checkbox" class="messageCheckbox" name="store_name" id="store_name" value="store_name,Tên chi nhánh">
                            <label for="store_name">Tên chi nhánh</label>
                        </div>
                        <div class="col-lg-4">
                            <input type="checkbox" class="messageCheckbox" name="address" id="address" value="address,Địa chỉ">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4">
                            <input type="checkbox" class="messageCheckbox" name="created_at" id="created_at" value="created_at,Ngày tạo">
                            <label for="created_at">Ngày tạo</label>
                        </div>
                    </div>
                    <div class="form-group m-form__group row">
                        <div class="col-lg-4">
                            <input type="checkbox" class="messageCheckbox" name="is_active" id="is_active" value="is_active,Trạng thái">
                            <label for="is_active">Trạng thái</label>
                        </div>
                        <div class="col-lg-4">
                            <input type="checkbox" class="messageCheckbox" name="store_image" id="store_image" value="store_image,Hình ảnh">
                            <label for="store_image">Hình ảnh</label>
                        </div>
                        <div class="col-lg-4">

            ...
            <div class="modal-body">
                ...
                <form action="{{route('admin.order-status.export')}}" id="formexport" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                        ...
                        <div class="col-lg-4">
                            <input type="checkbox" class="messageCheckbox" name="order_status_description" id="order_status_description" value="order_status_description,Ghi chú">
                            <label for="order_status_description" >Ghi chú</label>
                        </div>
                    <div class="col-lg-4">

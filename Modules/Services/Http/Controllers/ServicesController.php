...
class ServicesController extends Controller
{
    ...
    public function __construct(ServicesRepositoryInterface $service, ServiceTimeRepositoryInterface $serviceTime)
    {

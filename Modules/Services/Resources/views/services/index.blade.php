            ...
            <div class="m-portlet m-portlet--mobile ">
                ...
                <div class="m-portlet__body" id="autotable">
                    ...
                    <div class="table-content">
                        @include('service::services.services-list')
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/services/service/service-list.js')}}" type="text/javascript"></script>
@stop
@section('after_style')
    <link href="{{asset('static/backend/css/pretty-checkbox.min.css')}}" rel="stylesheet" type="text/css"/>
@stop
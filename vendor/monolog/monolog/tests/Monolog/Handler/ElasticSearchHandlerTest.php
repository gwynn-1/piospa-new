...
class ElasticSearchHandlerTest extends TestCase
{
    ...
    public function testHandle()
    {
        ...
        $formatter = new ElasticaFormatter($this->options['product-group'], $this->options['type']);
    ...
    {
        $expected = array(
            'product-group' => $this->options['product-group'],
    ...
    public function testHandleIntegration()
    {
        ...
        $document = $this->getDocSourceFromElastic(
            $client,
            $this->options['product-group'],
            $this->options['type'],
            $documentId
        );
        $this->assertEquals($expected, $document);

        // remove test product-group from ES
        $client->request("/{$this->options['product-group']}", Request::DELETE);
    }

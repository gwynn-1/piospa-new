...
abstract class Text extends Base
{
     ...
     * generates a weighted table with the specified number of words as the product-group and the
     ...
     *                             generated text usually doesn't make sense. Higher product-group sizes (up to 5)

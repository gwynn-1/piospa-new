...
class ProviderMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $description = 'Create a new services provider class for the specified module.';
    ...
    {
        return [
            ['name', InputArgument::REQUIRED, 'The services provider name.'],
    ...
    {
        return [
            ['master', null, InputOption::VALUE_NONE, 'Indicates the master services provider', null],
        ];
    }

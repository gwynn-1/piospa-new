<?php $__env->startSection('page_subheader'); ?>
    <?php echo $__env->make('components.subheader', ['title' => 'Dịch vụ'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <div class="m-portlet__body" id="autotable">
                                ...
                                <div class="col-xl-6 order-2 order-xl-1">
                                    <div class="form-group m-form__group row align-items-center">
                                        <div class="input-group col-xs-10">
                                            ...
                                            <input type="text" id="generalSearch" class="form-control" name="search_keyword"
                                ...
                                <div class="col-xl-6 order-1 order-xl-2 m--align-right">
                                    ...
                                    <a href="#" id="exportExcelBtn" data-toggle="modal" data-target="#formExportExcel"
                                       class="btn m-btn--pill m-btn--air btn-primary"><i
                                        ...
                                        Excel</a>
                                    <a href="<?php echo e(route('services.add')); ?>"
                    ...
                    <?php if(session('status')): ?>
                        <div class="alert alert-success alert-dismissible">
                            <strong>Success : </strong> <?php echo session('status'); ?>.
                        </div>
                    <?php endif; ?>
                    <div class="table-content">
                        <?php echo $__env->make('service::services.services-list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div><!-- end table-content -->
                </div>
                <?php echo $__env->make('service::services.export-excel', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
    </div>
...
<?php $__env->startSection('after_script'); ?>
    ...
    <script src="<?php echo e(asset('static/backend/js/services/service/service-list.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('after_style'); ?>
    <link href="<?php echo e(asset('static/backend/css/pretty-checkbox.min.css')); ?>" rel="stylesheet" type="text/css"/>
<?php $__env->stopSection(); ?>

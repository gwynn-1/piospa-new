                ...
                <div class="m-portlet__body" id="autotable">
                        ...
                        <div class="m-form m-form--label-align-right m--margin-bottom-30">
                            <div class="row align-items-center m--margin-bottom-10">
                                ...
                                <div class="col-xl-6 order-1 order-xl-2 m--align-right">
                                    ...
                                    <a href="<?php echo e(route('customer.add')); ?>" class="btn m-btn--pill m-btn--air btn-primary"><i class="la la-plus-square"></i> Thêm khách hàng</a>
                    ...
                    <?php if($message = Session::get('success')): ?>
                        <div class="alert alert-success alert-dismissible">
                            ...
                            <strong>Danger!</strong> <?php echo e($message); ?>

                        </div>
                    <?php endif; ?>
                    <div class="table-content">
                        <?php echo $__env->make('customer::customer.list', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('after_script'); ?>
    <script src="<?php echo e(asset('static/backend/js/admin/customer/list.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>

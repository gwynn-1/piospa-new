				...
				<div class="m-stack m-stack--ver m-stack--general">
					<div class="m-stack__item m-stack__item--middle m-brand__logo">
						<a href="index.html" class="m-brand__logo-wrapper">
							<img alt="" src="<?php echo e(asset('static/backend/assets/demo/demo9/media/img/logo/logo.png')); ?>"/>
						</a>
					</div>
											...
											<ul class="m-menu__content">
												<li class="m-menu__item">
													...
													<ul class="m-menu__inner">
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("service-group")); ?>" class="m-menu__link ">
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("customer-source")); ?>" class="m-menu__link ">
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("service-package")); ?>" class="m-menu__link ">
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("service-type")); ?>" class="m-menu__link ">
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("product-unit")); ?>" class="m-menu__link ">
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("customer-group")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Customer Group
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("admin.product-origin")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Product Origin
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("admin.product-label")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Product Label
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("admin.staff-title")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Staff Title
																</span>
												...
												<li class="m-menu__item">
													...
													<ul class="m-menu__inner">
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("order-payment-type")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Order Payment Type
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("product-group")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Product Group
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("member-level")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Member Level
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("order-delivery-status")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("admin.order-status")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Order Status
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("admin.order-reason-cancel")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Order Reason Cancel
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("admin.member-level-verb")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Member Level Verb
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("admin.staff-department")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Staff Department
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("admin.store")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Store
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("admin.tax")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Tax
																</span>
												...
												<li class="m-menu__item">
													...
													<ul class="m-menu__inner">
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("user")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	User
																</span>
										...
										<div class="m-menu__subnav">
											<ul class="m-menu__content">
												<li class="m-menu__item">
													...
													<ul class="m-menu__inner">
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("customer")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-map"></i>
																<span class="m-menu__link-text">
																	Customer
																</span>
												...
												<li class="m-menu__item">
													...
													<ul class="m-menu__inner">
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("services")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Services
																</span>
										...
										<div class="m-menu__subnav">
											<ul class="m-menu__content">
												<li class="m-menu__item">
													...
													<ul class="m-menu__inner">
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("staff")); ?>" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-map"></i>
																<span class="m-menu__link-text">
																	Staff
																</span>
												...
												<li class="m-menu__item">
													...
													<ul class="m-menu__inner">
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="<?php echo e(route("staff-account")); ?>" class="m-menu__link ">
...
data-dropdown-toggle="click" data-dropdown-persistent="true" id="m_quicksearch" data-search-type="dropdown">
							...
							<li class="m-nav__item m-dropdown m-dropdown--medium m-dropdown--arrow  m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" data-dropdown-toggle="click">
								<?php echo $__env->make('components.profile', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
							</li>

				...
				<div class="m-stack m-stack--ver m-stack--general">
					<div class="m-stack__item m-stack__item--middle m-brand__logo">
						<a href="index.html" class="m-brand__logo-wrapper">
							<img alt="" src="{{asset('static/backend/assets/demo/demo9/media/img/logo/logo.png')}}"/>
						</a>
					</div>
											...
											<ul class="m-menu__content">
												<li class="m-menu__item">
													...
													<ul class="m-menu__inner">
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("service-group")}}" class="m-menu__link ">
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("service-package")}}" class="m-menu__link ">
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("service-type")}}" class="m-menu__link ">
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("product-unit")}}" class="m-menu__link ">
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("admin.product-origin")}}" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Product Origin
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("admin.product-label")}}" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Product Label
																</span>
												...
												<li class="m-menu__item">
													...
													<ul class="m-menu__inner">
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("order-payment-type")}}" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Order Payment Type
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("product-group")}}" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Product Group
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("member-level")}}" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Member Level
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("order-delivery-status")}}" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("admin.order-status")}}" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Order Status
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("admin.order-reason-cancel")}}" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Order Reason Cancel
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("admin.member-level-verb")}}" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Member Level Verb
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("admin.staff-department")}}" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Staff Department
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("admin.store")}}" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Store
																</span>
														...
														<li class="m-menu__item "  data-redirect="true" aria-haspopup="true">
															<a  href="{{route("admin.tax")}}" class="m-menu__link ">
																<i class="m-menu__link-icon flaticon-graphic-2"></i>
																<span class="m-menu__link-text">
																	Tax
																</span>
